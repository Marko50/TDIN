 ...
 */
package com.feup.pizzaria.service;

import com.feup.pizzaria.Orders;
 ...
 */
@Stateless
@Path("com.feup.pizzaria.orders")
public class OrdersFacadeREST extends AbstractFacade<Orders> {

    @PersistenceContext(unitName = "com.feup_Pizzaria_war_1.0-SNAPSHOTPU")
